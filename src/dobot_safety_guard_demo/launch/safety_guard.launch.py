    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="安全演示 YAML 配置文件路径。 / Path to the safety demo YAML configuration file.",
            ),
            DeclareLaunchArgument(
                "grpc_addr",
                default_value="192.168.5.2:50051",
                description="机器人 gRPC 地址。 / Robot gRPC address.",
            ),
            DeclareLaunchArgument(
                "rviz",
                default_value="true",
                description="是否使用演示配置启动 RViz2。 / Whether to start RViz2 with the demo configuration.",
            ),
            ExecuteProcess(
                cmd=[
                    "python",
